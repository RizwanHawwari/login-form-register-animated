...
<body>
  <div class="container">
    <div class="img">
      <img src="img/logo-cn.png" alt="Logo SMK Citra Negara" width="150" height="140">
    </div>
    <div class="login-box">
      <?php if ($err) { ?>
      ...
      <form id="loginform" action="" method="post" role="form" autocomplete="off">
        <div class="input-box">
          <input id="login-username" type="text" name="username" value="<?php echo htmlspecialchars($username) ?>" required>
        ...
        <div class="remember-box">
          <input id="login-remember" type="checkbox" name="ingataku" value="1" <?php if ($ingataku == '1') echo "checked" ?>>
